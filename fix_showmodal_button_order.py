#!/usr/bin/env python3
"""
Inverser l'ordre: cancelBtn AVANT okBtn
"""
...
# Trouver showModal et extraire sa position
start = content.find('function showModal(')
if start == -1:
    print("❌ showModal() non trouvée!")
    exit(1)

# Trouver la fin de la fonction (premier } au même niveau)
depth = 0
end = -1
...
print("✅ Ordre des boutons inversé!")
print("✓ Annuler créé EN PREMIER → À GAUCHE")
print("✓ Accepter créé EN DERNIER → À DROITE")
