...
// Remplace la fonction checkToken pour ajouter du debug
const old = `function checkToken(t) {
  try {
    const [p, s] = t.split('.');
...
content = content.replace(old, newFunc);
fs.writeFileSync(file, content);
console.log('✅ checkToken() debug ajouté');
